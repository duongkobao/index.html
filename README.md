...
<div class="wrap">
  <div class="shell">
    ...
    <section class="panel" aria-label="Hồ sơ">
      <div class="head">
        <div class="avatar" id="avatar" title="Nhấn để thả tim">
          <img src="https://i.imgur.com/qQrMhxI.jpeg" alt="Avatar" loading="lazy" />
      ...
      <div class="badges">
        <span class="badge">📍 Ha Noi, Việt Nam</span>
        <span class="badge">☎ 0374815337</span>
        <span class="badge">✉ duongkobao07@hotmail.com</span>
      </div>
      <p class="bio">💻 Developer | Tool | MMO | TRICKER 💕</p>
      <div class="actions">
        <a class="btn" id="cta" href="https://www.facebook.com/HungDuong.Support" target="_blank" rel="noopener">LIÊN HỆ</a>
    ...
    <section class="panel" aria-label="Liên kết & mạng xã hội">
      ...
      <div class="grid">
        <a class="tile" href="https://github.com/duongkobao" target="_blank" rel="noopener">💻 <strong>GitHub</strong></a>
        <a class="tile" href="https://tiktok.com/lhd_0907" target="_blank" rel="noopener">👀 <strong>TikTok</strong></a>
        <a class="tile" href="https://t.me/hungduongsupport" target="_blank" rel="noopener">📝 <strong>Tele</strong></a>
      </div>
      <div class="section">Theo dõi nhanh</div>
      <div class="grid">
        <a class="tile" href="https://www.tiktok.com/@lhd_0907" target="_blank" rel="noopener">▶ <strong>TikTok</strong></a>
        <a class="tile" href="https://www.facebook.com/HungDuong.Support" target="_blank" rel="noopener">📘 <strong>Facebook</strong></a>
        <a class="tile" href="https://zalo.me/0374815337" target="_blank" rel="noopener">💬 <strong>Zalo</strong></a>
      ...
      <div class="footer">© 2026 • Hùng Dương | Tricker Team</div>
    </section>
  </div>
</div>
...
document.getElementById('copyMail')?.addEventListener('click',(e)=>{e.preventDefault(); safeCopy('duongkobao07@hotmail.com')});
document.getElementById('copyPhone')?.addEventListener('click',(e)=>{e.preventDefault(); safeCopy('0374815337')});
